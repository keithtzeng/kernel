...
const struct snd_soc_dapm_route max_98390_dapm_routes[] = {
         /* speaker */
         { "LR Spk", NULL, "Left Rear BE_OUT" },
         { "RR Spk", NULL, "Right Rear BE_OUT" },
         { "LF Spk", NULL, "Left Front BE_OUT" },
         { "RF Spk", NULL, "Right Front BE_OUT" },
 };
...
static struct snd_soc_codec_conf max_98390_codec_conf[] = {
        {
                ...
                .name_prefix = "Right Rear",
        },
        {
                .dlc = COMP_CODEC_CONF(MAX_98390_DEV1_NAME),
                .name_prefix = "Left Rear",
        },
        {
                .dlc = COMP_CODEC_CONF(MAX_98390_DEV2_NAME),
                .name_prefix = "Right Front",
        },
        {
                .dlc = COMP_CODEC_CONF(MAX_98390_DEV3_NAME),
                .name_prefix = "Left Front",
        },
};
